...
mod tests {
    ...
    use crate::state::{AssetDetails, ComplianceInfo, Document, FinancialTerms};
    ...
    fn test_create_proposal() {
        ...
        assert!(res.events.iter().any(|e| e
            .attributes
            .iter()
            .any(|a| a.key == "method" && a.value == "create_proposal")));
        assert!(res.events.iter().any(|e| e
            .attributes
            .iter()
    ...
    fn test_invest_in_proposal() {
        ...
        assert!(res.events.iter().any(|e| e
            .attributes
            .iter()
            .any(|a| a.key == "amount" && a.value == "1000000000")));
    }
    ...
    fn test_invalid_funding_period() {
        ...
        let (mut asset_details, mut financial_terms, documents, compliance) =
    ...
    fn test_update_proposal() {
        ...
        assert_eq!(
            res.proposal.asset_details.description,
            "Updated description"
        );
    }
