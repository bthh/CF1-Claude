      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Active Funding</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalRaised}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400">Total Raised</p>
          </div>
          <div className="text-center">
            <div className="flex items-center justify-center w-14 h-14 bg-purple-100 dark:bg-purple-900/20 rounded-lg mx-auto mb-3">
              <Calendar className="w-8 h-8 text-purple-600 dark:text-purple-400" />
            </div>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.avgAPY}</p>
