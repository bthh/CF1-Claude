...
const SpotlightCard: React.FC<SpotlightAsset> = ({
  ...
  return (
    <div className="card-hover p-6 cursor-pointer border border-secondary-200 rounded-lg">
...
const Performance: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-secondary-900">Spotlight</h1>
          <p className="text-secondary-600 mt-1">Discover trending assets and premium investment opportunities.</p>
        </div>
      </div>
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-secondary-900">Trending</h2>
          <div className="flex items-center space-x-2">
            <Trophy className="w-5 h-5 text-yellow-500" />
            <span className="text-sm text-secondary-600">Hot Assets</span>
          </div>
        </div>
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-secondary-900">New</h2>
          <div className="flex items-center space-x-2">
            <Star className="w-5 h-5 text-blue-500" />
            <span className="text-sm text-secondary-600">Latest Launches</span>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {newAssets.map((asset) => (
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-secondary-900">Ready to Launch</h2>
          <div className="flex items-center space-x-2">
            <Rocket className="w-5 h-5 text-purple-500" />
            <span className="text-sm text-secondary-600">Coming Soon</span>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
